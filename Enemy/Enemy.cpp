...
Enemy::Enemy(char* _name, int _health, int _attack, int _defense, int _speed, int _experience)
        : Character(_name, _health, _attack, _defense, _speed, false), experience(_experience) {}
...
// Implementación del método moreDificult
void Enemy::moreDificult() {
    ...
    experience = static_cast<int>(experience * 1.5);
}
